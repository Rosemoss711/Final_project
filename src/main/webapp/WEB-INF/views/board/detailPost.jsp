        ...
        <body>
            <div>
                ...
                <div class="row mt-3 mb-5"> <!-- 게시물 내용 -->
                    <div class="col d-none d-md-block" style="margin: 10px 10vw 10px 10vw; font-size: 13px;">
                ...
                <div class="row mb-4 mt-5" style="margin: 0 10vw 0 10vw;">
                    <div class="col d-flex justify-content-center pb-3" style="border-bottom: 1px solid lightgray; margin: 0 12px 0 12px;">
                ...
                <div class="row">
                    <div class="col d-none d-md-block" style="margin: 0 10vw 0 10vw;">
